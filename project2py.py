...
st.sidebar.header(":wave: :purple[**Welcome to dashboard!**]")
...
if selected == "Home":
    ...
    with col1:
        ...
        st.markdown("### :red[Overview :]  This streamlit app can be used to visualize the PhonePe pulse data and gain lots of insights on Transactions, Number of users, Top 10 state, District, Pincode. Bar charts, Pie charts and Geo map visualization are used to get insights.")
    with col2:
        st.write(" ")
        st.write(" ")
        st.write(" ")
        #st.image("statimage.png")
#MENU 2 - TOP CHARTS
...
if selected == "About":
    ...
    with col1:
        st.write(" ")
        st.write(" ")
        st.markdown("### :green[About PhonePe Pulse:] ")
